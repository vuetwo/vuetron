...
To use Vuetron, you will need both the desktop application and install the library in your Vue project.  You can find full installation instructions ![here](./docs/INSTRUCTIONS.md).
